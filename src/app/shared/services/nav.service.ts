...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{
			path: '/student/dashboard', title: 'My Dashboard', icon: 'home', type: 'link'
		},
		{
			title: 'My Courses', icon: 'home', type: 'sub', badgeType: 'primary', badgeValue: 'new', active: false, children: [
				{
					path: '',
					title: 'Webscripting & Angular Framework',
					type: 'link'
				}
			]
		},
		{
			title: 'My Activities', icon: 'home', type: 'sub', badgeType: 'primary', badgeValue: 'new', active: false, children: [
				{
